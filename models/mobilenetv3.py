...
class MobileNetV3(nn.Module):
    def __init__(self, model_mode="LARGE", num_classes=2, multiplier=1.0, dropout_rate=0.0):
...
# model = MobileNetV3(model_mode="SMALL", num_classes=2, multiplier=1.0)
