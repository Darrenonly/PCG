...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, growth_rate):
        ...
        self.conv1 = GhostModule(in_planes, 4*growth_rate, kernel_size=3)
        self.bn2 = nn.BatchNorm1d(4*growth_rate)
        self.conv2 = GhostModule(4*growth_rate, growth_rate, kernel_size=3)
...
class Transition(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.conv = GhostModule(in_planes, out_planes, kernel_size=1)
