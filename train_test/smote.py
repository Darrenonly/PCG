...
from train_test.base_sampler import *
import numpy as np
...
def make_sample(old_feature_data, diff):
    ...
    # print(type(old_feature_data[0][0]))
...
if __name__ == '__main__':
    ...
    dir = os.path.join(FEATPATH, "train5.npy")
    # dir = 'G:\hu\Desktop\Mechine-Learning-master\ImBalance\imbalanced_train_data_arr2.npy'
    imbalanced_data = np.load(dir, allow_pickle=True)
    print(imbalanced_data.shape)
    # minor_data_arr2, major_data_arr2 = seperate_minor_and_major_data(imbalanced_data)
    # print(minor_data_arr2[0][0].shape)
    # print(minor_data_arr2[10][0].shape)
    # print(minor_data_arr2[20][0].shape)
    ...
    np.save(os.path.join(FEATPATH, "newtrain"),balanced_data_arr2)